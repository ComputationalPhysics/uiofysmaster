...
\definecolor{listingsincludecolor}{rgb}{0.0,0.0,0.5}
% \definecolor{listingsvariablecolor}{rgb}{0.5,0.0,0.5}

\RequirePackage{iftex}

% Make sure minus doesn't convert to hyphen
\makeatletter
\lst@CCPutMacro\lst@ProcessOther {"2D}{\lst@ttfamily{-{}}{-{}}}
\@empty\z@\@empty
\makeatother
% End minus hyphen conversion fix
...
\lstset {
  ...
  %   numbers=left,                    % where to put the line-numbers; possible values are (none, left, right)
    ...
    keywordstyle=[4]{\color{listingsincludecolor}\footnotesize\listingsfont},
}
